return {
  {
    ...
    config = function()
      ...
      map('n', '<leader>sf', tb.find_files, { desc = 'Telescope find files' })
      map('n', '<leader>sg', tb.live_grep, { desc = 'Telescope live grep' })
      map('n', '<leader><leader>', tb.buffers, { desc = 'Telescope buffers' })
      map('n', '<leader>sh', tb.help_tags, { desc = 'Telescope help tags' })
      map('n', '<leader>sk', tb.keymaps, { desc = 'Telescope find keymaps' })
